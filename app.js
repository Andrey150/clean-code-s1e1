...
let createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="task task__edit-input";
...
//select ListItems children
  ...
  let editButton=taskListItem.querySelector("button.task__edit");
  let deleteButton=taskListItem.querySelector("button.task__delete");
